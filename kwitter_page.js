var firebaseConfig = {
  apiKey: "AIzaSyApAz2gNrYLNM4HKQ9gPSUdA5tMMtrsQjY",
  authDomain: "kwitter-project-499ea.firebaseapp.com",
  databaseURL: "https://kwitter-project-499ea-default-rtdb.firebaseio.com",
  projectId: "kwitter-project-499ea",
  storageBucket: "kwitter-project-499ea.appspot.com",
  messagingSenderId: "160569140762",
  appId: "1:160569140762:web:6127ac8fa1f0c529d5d3a3"
};
// Initialize Firebase
...
function getData() { firebase.database().ref("/"+room_name).on('value', function(snapshot) { document.getElementById("output").innerHTML = ""; snapshot.forEach(function(childSnapshot) { childKey  = childSnapshot.key; childData = childSnapshot.val(); if(childKey != "purpose") {
         ...
         firebase_message_id2 = childKey;

         message_data = childData;
//Start code
         console.log(firebase_message_id);
         console.log(firebase_message_id2);
